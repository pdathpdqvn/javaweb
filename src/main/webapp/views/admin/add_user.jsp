						...
						<div class="card-body">
							...
							<form action="add_user" method="post">
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" name="userId" class="form-control" id="yourUserId"  >
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										...
										<div class="form-check">
											<input class="form-check-input" name="status" value="0" type="checkbox"> <label class="form-check-label"

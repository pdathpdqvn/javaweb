				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="add_product" class="btn btn-primary mb-3">Thêm mới</a>
								...
								<tbody>
									...
									<c:forEach items="${requestScope.products}" var="p">
										<tr>
											...
											<td>${p.productName}</td>
											<td>
											<img style="width: 65px" src="views/images/${p.imagePath}" alt="IMG-PRODUCT">
											</td>
											<td>${p.price}</td>
											...
											<td><a href="update_product?id=${p.productId}"><i
													class="fa-solid fa-pen-to-square"></i></a> | <a href="#"
												onclick="deleteProduct('${p.productId}')"><i

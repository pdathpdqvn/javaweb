...
<body>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="add_user" class="btn btn-primary mb-3">Thêm mới</a>
								...
								<tbody>
									...
									<c:forEach items="${requestScope.users}" var="u">
										<tr>
											...
											<td>${u.address}</td>
											<td>${u.role}</td>
											<td><a href="update_user?id=${u.userId}"><i
													class="fa-solid fa-pen-to-square"></i></a> | <a href="#"
												onclick="deleteUser('${u.userId}')"><i
	...
	<script type="text/javascript">
		function deleteUser(userId){
			if(confirm("Bạn có chắc chắn xóa "+userId)){

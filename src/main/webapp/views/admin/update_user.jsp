						...
						<c:set var="u" value="${requestScope.user}"></c:set>
							...
							<form action="update_user" method="post">
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="number" value="${u.userId}" name="userId" class="form-control" readonly>
									</div>
								</div>
								<div class="row mb-3">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="password" value="${u.password}" name="password" class="form-control">
									</div>
								</div>
								<div class="row mb-3">
									<label for="" class="col-sm-2 col-form-label">Tên người dùng</label>
									<div class="col-sm-10">
										<input type="text" value="${u.fullname}" name="fullname" class="form-control">
									</div>
								</div>
								<div class="row mb-3">
									<label for="" class="col-sm-2 col-form-label">Số điện thoại</label>
									<div class="col-sm-10">
										<input type="text" value="${u.phone}" name="phone" class="form-control">
									</div>
								</div>
								<div class="row mb-3">
								...
								<div class="row mb-3">
									<legend class="col-form-label col-sm-2 pt-0">Quyền</legend>
									<div class="col-sm-10">

										<div class="form-check">
											<input class="form-check-input" name="role" value="1" type="checkbox"> <label class="form-check-label"
												for="gridCheck1"> Admin </label>
										</div>
